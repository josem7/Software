...
class EventosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post eventos_url, params: { evento: { fecha_creacion: @evento.fecha_creacion, tipo: @evento.tipo } }
    end
  ...
  test "should update evento" do
    patch evento_url(@evento), params: { evento: { fecha_creacion: @evento.fecha_creacion, tipo: @evento.tipo } }
